    ...
    <div class="flex flex-col w-full h-screen p-6">
        ...
        <div class="flex flex-col h-5/6 w-full gap-5">
            ...
            <div class="flex flex-row items-center justify-evenly h-1/2 w-full">
                <!-- Left -->
                <div class="w-5/12 h-full bg-white border-white shadow-md rounded-md" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;">
                    <!-- Top -->
                    <div class="flex flex-row items-center justify-center w-2/5 p-2">
