    ...
    <div class="flex h-screen w-full">
       <!-- Sidebar -->
        <aside class="fixed h-full w-52 bg-white shadow-2xl text-white px-2 py-4 rounded-r-md">
            ...
            <!-- Navigation -->
            <nav class="flex flex-col mt-3 p-3 gap-6 w-full">
                <!-- Add your navigation links here -->
                <div class="{{ request()->routeIs('news') ? 'bg-violet-700' : '' }} flex justify-start items-center w-44 rounded-md p-1 h-10">
                    ...
                    <x-side-nav-link href="{{ route('news') }}" :active="request()->routeIs('news')" class="text-lg font-medium mt-1 flex items-center">
                        {{ __('Overview')}} 
                    </x-side-nav-link>
                </div>
            
                <!-- User -->
                <div class="{{ request()->routeIs('home') ? 'bg-violet-700' : ''}} flex justify-start items-center w-44 rounded-md p-1 h-10">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#999C9A" class="w-6 h-6 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>                                                                                                                             
                    <x-side-nav-link href="{{ route('home') }}" :active="request()->routeIs('home')" class="text-lg font-medium mt-1">
                        {{ __('User')}}
                    </x-side-nav-link>
                </div>
