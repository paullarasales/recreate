...
<body class="font-poppins antialiased">
    <div class="relative h-full md:flex justify-between">
       <!-- Sidebar -->
        <aside class="z-10 bg-background w-52 border-r-[3px] border-solid border-black-700 text-white px-2 py-4 absolute inset-y-0 left-0 md:relative transform -translate-x-full md:translate-x-0 transition ease-in-out-200 shadow-lg overflow-y-auto min-h-screen">
            <!-- Logo -->
            <div class="flex items-center justify-between px-2 py-1">
                <div class="flex gap-2 items-center">
                    ...
                    <span class="text-2xl text-black font-semibold"><span class="text-red-300">ResQ</span>Pets<span class="text-red-300">.</span></span>
                </div>
            </div>
            <!-- Navigation -->
